...
(function () {
	...
	/* src/content-script/App.svelte generated by Svelte v4.2.19 */
	const file = "src/content-script/App.svelte";
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				t1 = text(/*name*/ ctx[0]);
				t2 = text("!");
				attr_dev(h1, "class", "svelte-1hgnfvv");
				add_location(h1, file, 5, 2, 48);
				attr_dev(main, "class", "svelte-1hgnfvv");
